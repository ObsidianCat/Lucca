...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2015 at 12:57 PM
...
(2, 'CaterinaYorkshire', 'United Kingdom', '2015-08-15 13:36:35', '2015-08-15', 'CaterinaYorkshire@gmail.com', 5, 'message":"Beautiful, not to commercialised, some really interesting sculptures invlipuding a life sized Christ, which is used as part of the September festival every September, only 3? and the money is used to support the restoration.', 1),
(3, 'Suzbuster', 'USA', '2015-08-15 13:36:44', '2015-08-15', 'suzbuster@gmail.com', 2, 'message":"This duomo doesn''t compare in scale, colour, beauty or grandeur to other duomos I have seen over the past few days (Siena and Pisa). In fact Lucca as a whole did nothing for me and I am quite annoyed at Lonely Planet for putting in Italy''s top 10 destinations.', 1);
